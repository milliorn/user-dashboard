    ...
    <div className="grid lg:grid-cols-6 gap-4 p-4">
      <div className="lg:col-span-2 col-span-1 bg-white dark:bg-black dark:text-white flex justify-between w-full border p-4 rounded-lg">
        <div className="flex flex-col w-full pb-4">
          <p className="text-sm sm:text-2xl font-bold">{dailyRevenue}</p>
      ...
      <div className="lg:col-span-2 col-span-1 bg-white dark:bg-black dark:text-white flex justify-between w-full border p-4 rounded-lg">
        <div className="flex flex-col w-full pb-4">
          <p className="text-sm sm:text-2xl font-bold">{yearlyRevenue}</p>
          <p className="text-gray-600 dark:text-gray-200 text-sm sm:text-base">
            YTD Revenue
          </p>
        </div>
      ...
      <div className="lg:col-span-2 col-span-1 bg-white dark:bg-black dark:text-white flex justify-between w-full border p-4 rounded-lg">
        <div className="flex flex-col w-full pb-4">
          <p className="text-sm sm:text-2xl font-bold">{customers}</p>
          <p className="text-gray-600 dark:text-gray-200 text-sm sm:text-base">
            Customers
          </p>
        </div>
